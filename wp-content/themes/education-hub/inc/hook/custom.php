...
if ( ! function_exists( 'education_hub_footer_copyright' ) ) :
	...
	function education_hub_footer_copyright() {
	    ...
	    <?php endif; ?>
	    <div class="site-info">
	      <a href="<?php echo esc_url( __( 'http://www.education.gouv.ci/', 'education-hub' ) ); ?>"><?php printf( esc_html__( '%s', 'education-hub' ), 'education.gouv.ci' ); ?></a>
	      <span class="sep"> | </span>
			<?php printf( esc_html__( '%1$s by %2$s', 'education-hub' ), 'IEPP Cocody Deux-Plateaux', '<a href="' . esc_url( 'https://sercom.ieppcocodydeuxplateaux.ci' ) . '" rel="designer" target="_blank">SERCOM | +225 57 797 832 / 55 022 666</a>' ); ?>
	    </div><!-- .site-info -->
	    <?php
